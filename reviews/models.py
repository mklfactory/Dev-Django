"""Data models for tickets, reviews, and the follow relationship between users."""
...
class Ticket(models.Model):
    """A request for a review, optionally illustrated with an image."""
...
class Review(models.Model):
    """A rated critique written in response to a ticket."""
...
class UserFollows(models.Model):
    """A one-way follow relationship: `user` follows `followed_user`."""
